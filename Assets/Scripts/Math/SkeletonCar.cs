...
public static class SkeletonCar
{
  ...
  /// <param name="d">Driving distance [m]</param>
  ...
  /// <summary>
  /// Calculate the car's new heading independent of position
  /// </summary>
  /// <param name="theta">The car's heading (= rotation) [rad]</param>
  /// <param name="beta">Steering angle [rad]</param>
  ...
  /// <param name="carHeading">The car's heading [rad]</param>
  ...
  public static Vector3[] GetCornerPositions(Vector3 carPos, float carHeading, float carWidth, float carLength, Vector3[] cornerPositions)
  {
    ...
    cornerPositions[0].x = xFR;
    cornerPositions[0].z = zFR;

    cornerPositions[1].x = xFL;
    cornerPositions[1].z = zFL;

    cornerPositions[2].x = xBR;
    cornerPositions[2].z = zBR;

    cornerPositions[3].x = xBL;
    cornerPositions[3].z = zBL;


    //Not needed to return but better from a readability pov
